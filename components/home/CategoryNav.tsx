...
export function CategoryNav({ active, onSelect }: CategoryNavProps) {
  return (
    <section className="relative z-20 mx-auto -mt-7 max-w-6xl px-4">
      <div className="rounded-[1.75rem] border border-white/80 bg-white/80 p-3 shadow-xl shadow-dark/5 backdrop-blur">
        <div className="mb-3 flex items-end justify-between gap-3 px-2 pt-1">
          <div>
          ...
          <p className="hidden text-sm text-dark/40 sm:block">点一次分类，再点一次返回全部</p>
        </div>
